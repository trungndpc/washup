...
class RejectOrderModal extends React.Component {
    constructor(props) {
        super(props)
                                            ...
                                            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div className="form-group">
                                                    <div className="nk-int-st">
                                                        <textarea ref={e => this.noteRef = e} className="form-control" rows={2} placeholder="Vui lòng nhập lý do hủy" defaultValue={""} />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
